...
class StaffAdmin(admin.ModelAdmin):
	...
	list_per_page = 50
	list_display = ( 'id', 'services','link_to_user','phone_number', 'state', 'city', 'gender',  'create_date', 'status')
	list_display_links = ('id','link_to_user')
	list_filter = ('services', 'status', 'gender')
	search_fields = ('phone_number', 'services__title','user__username')
